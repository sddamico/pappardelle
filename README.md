...
4. **PR/MR creation** — A placeholder PR (GitHub) or MR (GitLab) is created from the new branch. Its body links back to the tracker issue, or names the issue key for beads.
